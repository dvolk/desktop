...
# desktop packages
sudo apt -y install gimp emacs osmo kiwix blender rawtherapee feh mpv fbreader zathura zathura-djvu obs-studio virt-manager transmission gthumb gnome-weather gnome-tweaks
